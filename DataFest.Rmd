...
```{r}
library(readxl)
clients <- read.csv("C:/Users/82108/Desktop/연세대 수업/2023-1-2 수업/datafest/data/clients.csv")
head(clients)
```
...
```{r}
attorney<- read_csv("C:/Users/14243/Desktop/DataFest/data/attorneys.csv")
head(attorney)
...
```{r}
attorney_time<- read_csv("C:/Users/14243/Desktop/DataFest/data/attorneytimeentries.csv")
head(attorney_time)
...
```{r}
aftercovid<- read_csv("C:/Users/14243/Downloads/extractaftercovid(attorney).csv")
...
beforeaverage<- read_csv("C:/Users/14243/Documents/before_avg.csv")
View(beforeaverage)


afteraverage<- read_csv("C:/Users/14243/Documents/after_avg.csv")
View(afteraverage)
